...
export default function AboutSection({bg, textColor, height}) 
{
	return (
		...
		<div className="container-md bg-body border-6 border-primary-subtle rounded d-flex flex-column align-items-center justify-content-center py-5 my-5">
			...
			<p className="text-justify fs-4 mb-5 px-0 px-md-5"> Passioné par l'informatique, je m'intéresse au développement sous toutes ses formes, de la conception d'application à la résolution de problèmes techniques.<br/> 
